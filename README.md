...
El sistema se enfoca en el control de la mercancía, por lo que guarda los siguientes datos de cada producto:

Nombre de la prenda: Para identificar si es un jean, camisa o chaqueta.

Costo de fábrica: El dinero que la tienda pagó para conseguir el producto.

Precio de venta: El valor final al que se le ofrece al cliente.

Ganancia: La diferencia entre el precio y el costo, calculada automáticamente.
